...
1. Đọc PromtAI/.codex/results/change.md để biết vừa có gì được xây và nằm ở đâu.

2. Đọc các file đã thay đổi và bản kế hoạch ở PromtAI/.codex/results/plan.md.
...
4. Chạy test. Có con nào rớt thì ghi phần rớt vào PromtAI/.codex/results/result-test.md
   rồi DỪNG LẠI. Không tự sửa code.

5. Xanh hết thì cũng ghi rõ vào PromtAI/.codex/results/result-test.md.
